                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?= $row["cek_info"]; ?></td>
                                                <td>
                                                    <a href="cek_qualitycontrol.php?po_number=<?=$row['po_number']?>"><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-tambah">Detail</button></a>
                                                </td>
                                            </tr>
                                        <?php
                                            $i++;
